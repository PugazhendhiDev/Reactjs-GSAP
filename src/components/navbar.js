...
function Navbar() {
  ...
  return (
    <header className="bg-purple-300 z-[999] p-5 mb-4 rounded-2xl sticky top-0">
      <div className="flex">
        <a href="/">
          <h1 className="nav my-auto font-bold text-[22px] lg:text-3xl uppercase pr-2 mr-2 border-r-2 border-purple-500 lg:pr-5 lg:mr-5">
            Navbar
          </h1>
        </a>
        ...
        <a
          ...
          className="nav my-auto ml-auto flex text-white font-bold bg-red-400 p-1 rounded lg:rounded-xl lg:px-5 lg:py-2"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
